...
exports.ConfirmSubscriptionMutation = void 0;
var nexus_1 = require("nexus");
exports.ConfirmSubscriptionMutation = (0, nexus_1.extendType)({
    type: "Mutation",
    definition: function (t) {
        ...
        t.field("confirmSubscription", {
            type: "User",
            args: {
                sessionId: (0, nexus_1.nonNull)((0, nexus_1.stringArg)()),
                token: (0, nexus_1.nonNull)((0, nexus_1.stringArg)())
            },
            resolve: function (_, _a, _b, x) {
                var sessionId = _a.sessionId, token = _a.token;
                var prisma = _b.prisma, currentUser = _b.currentUser;
                return __awaiter(_this, void 0, void 0, function () {
                    var stripe, session, frequency, updatedUser;
