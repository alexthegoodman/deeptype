                                        ...
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                ...
                                                case 3:
                                                    ...
                                                    return [3 /*break*/, 4];
                                                case 4:
                                                    if (!(user && helpers.isDefinedWithContent(user))) return [3 /*break*/, 6];
                                                ...
                                                case 5:
                                                    ...
                                                    if (match) {
                                                        ...
                                                        console.error(ERROR_CODES_1["default"].B003);
                                                        reject(ERROR_CODES_1["default"].B003);
                                                    }
                                                    return [3 /*break*/, 7];
                                                case 6:
                                                    console.error(ERROR_CODES_1["default"].C001);
                                                    reject(ERROR_CODES_1["default"].C001);
                                                    _a.label = 7;
